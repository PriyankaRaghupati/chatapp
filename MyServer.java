...
public class MyServer {
	...
	MyServer() throws IOException {
		ss = new ServerSocket(1004); // create server socket(A server socket waits for requests to come in over the network. It performs some operation based on that request, and then possibly returns a result to the requester.)
		...
		while (true) {
			...
			MyThread2 m = new MyThread2(s2, al2, alname); // new thread for
															// maintaning the
															// list of user name
